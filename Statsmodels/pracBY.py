...
# Example p-values
p_values = np.array([0.02, 0.04, 0.06, 0.06, 0.09])

# Perform Benjamini-Yekutieli (BY) correction
reject, corrected_p_values, _, _ = multipletests(p_values, method='fdr_by')
reject, corrected_p_values, _, _ = multipletests(p_values, method='fdr_bh')

# Print the results
print("Original p-values:", p_values)
print("Corrected p-values (BY method):", corrected_p_values)
