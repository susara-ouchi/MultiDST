...
adj_p_list = [p_values, bonf_p, bonf_w_p,holm_p,holm_w_p,bh_p,bh_w_p,storey_q, perm_p]
sig_index_list = [significant_p,bonf_sig_index, bonf_w_sig_index,holm_sig_index,holm_w_sig_index,bh_sig_index,bh_w_sig_index,q_sig_index, perm_sig]
